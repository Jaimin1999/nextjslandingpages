...
import heroImg from "../../public/img/hero-content.png";
import starImg from "../../public/img/Star1.png";

export const Hero = () => {
  return (
    <>
      <div className="flex flex-wrap  xl:mt-20 mt-44 sm:px-20 px-8  relative">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="font-gilroy text-4xl font-bold leading-snug tracking-tight bg-gradient-to-r from-[#AE67FA]  to-[#F49867] inline-block text-transparent bg-clip-text lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Tell a better brand story
            </h1>
            <p className="py-5 font-semibold text-lg leading-normal text-[#3E4581]">
            ...
            <div className="flex flex-col sm:items-center sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="px-8 py-4 text-lg font-medium text-center text-white bg-gradient-to-r from-[#AE67FA] to-[#F49867] rounded-md "
              >
                Get Started
              </a>
              <a
                ...
                target="_blank"
                rel="noopener"
                className="px-8 py-4 text-lg font-medium text-center sm:ml-10 ml-0 sm:mt-0 mt-4 border-2 border-[#F49867] rounded-lg bg-white"
              >
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="flex flex-wrap justify-center gap-5 mt-10 md:justify-around sm:px-24 px-0">
      ...
      <div className="absolute sm:top-36 top-20 left-10">
        <Image
          src={starImg}
          width="100"
          height="100"
